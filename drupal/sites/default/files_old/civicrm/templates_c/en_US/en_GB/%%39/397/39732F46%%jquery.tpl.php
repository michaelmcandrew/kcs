...
<script type="text/javascript" src="<?php echo $this->_tpl_vars['config']->resourceBase; ?>
packages/jquery/jquery-ui-1.8.11/js/jquery-ui-1.8.11.custom.min.js"></script>
<style type="text/css">@import url("<?php echo $this->_tpl_vars['config']->resourceBase; ?>
packages/jquery/jquery-ui-1.8.11/css/smoothness/jquery-ui-1.8.11.custom.css");</style>
...
<script type="text/javascript" src="<?php echo $this->_tpl_vars['config']->resourceBase; ?>
packages/jquery/plugins/jsTree.v.1.0rc2/jquery.jstree.min.js"></script>
<style type="text/css">@import url("<?php echo $this->_tpl_vars['config']->resourceBase; ?>
packages/jquery/plugins/jsTree.v.1.0rc2/themes/default/jstree.css");</style>
...
<script type="text/javascript" src="<?php echo $this->_tpl_vars['config']->resourceBase; ?>
packages/jquery/plugins/DataTables-1.7.6/media/js/jquery.dataTables.min.js"></script>
<style type="text/css">@import url("<?php echo $this->_tpl_vars['config']->resourceBase; ?>
packages/jquery/plugins/DataTables-1.7.6/media/css/demo_table_jui.css");</style>
...
<script type="text/javascript" src="<?php echo $this->_tpl_vars['config']->resourceBase; ?>
js/jquery/jquery.crmrowhighlighter.js"></script>
